...
public class TestSimpleAlignment {
  public static void main(String [] args) {
    try {
      ...
      ResidueList res1 = SeqTools.createResidueList(10);
      ResidueList res2 = SeqTools.createResidueList(10);
      ResidueList res3 = SeqTools.createResidueList(10);
      ...
      for(Iterator i = ali.getLabels().iterator(); i.hasNext(); ) {
        ...
        ResidueList rl = ali.residueListForLabel(label);
      ...
      for(int i = 1; i <= ali.length(); i++) {
        System.out.println(i + ":\t" + ali.residueAt(i).getName());
      }
    } catch (Throwable t) {
      t.printStackTrace();
      System.exit(1);
