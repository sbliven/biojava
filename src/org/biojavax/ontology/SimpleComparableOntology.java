...
public class SimpleComparableOntology extends AbstractChangeable implements ComparableOntology {
    ...
    private Map terms = new SmallMap();
    ...
    private Set triples = new SmallSet();
    ...
    public Set getTriples(Term subject, Term object, Term predicate) {
        ...
        // Hibernate requirement - not for public use.
    private void setTripleSet(Set triples) {
        this.triples = triples;
    }
    
    // Hibernate requirement - not for public use.
    private Set getTripleSet() {
        return this.triples;
    }
    ...
    public Set getTerms() {
        ...
        return new SmallSet(this.terms.values());
        
    }
    
    // Hibernate requirement - not for public use.
    private void setTermSet(Set terms) {
        this.terms.clear();
        for (Iterator i = terms.iterator(); i.hasNext();) {
            SimpleComparableTerm t = (SimpleComparableTerm)i.next();
