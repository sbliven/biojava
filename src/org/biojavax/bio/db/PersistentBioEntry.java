...
public abstract class PersistentBioEntry extends SimpleBioEntry implements Persistent {
    ...
    protected PersistentBioEntry(PersistentBioDB db, BioEntry b) {
        ...
        try {
            ...
            Set rels = b.getBioEntryRelationships();
            
            for (Iterator i = rels.iterator(); i.hasNext();) this.addBioEntryRelationship((BioEntryRelationship)i.next());
    ...
    protected Set getAddedRelations() { return Collections.unmodifiableSet(this.addedRelations); }

    protected void resetAddedRelations() { this.addedRelations.clear(); }

    private Set removedRelations = new HashSet();

    protected Set getRemovedRelations() { return Collections.unmodifiableSet(this.removedRelations); }

    protected void resetRemovedRelations() { this.removedRelations.clear(); }
    ...
    public boolean removeBioEntryRelationship(BioEntryRelationship relationship) throws ChangeVetoException {
        ...
        this.removedRelations.add(relationship);

        this.addedRelations.remove(relationship);
    ...
    public void addBioEntryRelationship(BioEntryRelationship relationship) throws AlreadyExistsException, ChangeVetoException {
        ...
        super.addBioEntryRelationship(relationship);

        this.addedRelations.add(relationship);

        this.removedRelations.remove(relationship);
