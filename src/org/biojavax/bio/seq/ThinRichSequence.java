...
public class ThinRichSequence extends SimpleBioEntry implements RichSequence {
     ...
     * {@inheritDoc}
     */
    public List toList() { return RichObjectFactory.getDefaultRichSequenceHandler().toList(this);}
     ...
     * {@inheritDoc}
     */
    public String seqString() { return RichObjectFactory.getDefaultRichSequenceHandler().seqString(this); }
     ...
     * {@inheritDoc}
     */
    public Iterator iterator() { return RichObjectFactory.getDefaultRichSequenceHandler().iterator(this); }
    ...
    protected String getAlphabetName() {
        if (this.alphabet==null) return null;
    ...
    // Hibernate requirement - not for public use.
    protected void setSequenceLength(int length) { this.length = length; } 
