...
public interface CrossRef extends Comparable,Changeable {
     ...
     */
    public void setTerm(ComparableTerm term, int index) throws AlreadyExistsException,IllegalArgumentException,ChangeVetoException;
     ...
     * @throws IllegalArgumentException if the term is null.
     */
    public int addTerm(ComparableTerm term) throws AlreadyExistsException,IllegalArgumentException,ChangeVetoException;
