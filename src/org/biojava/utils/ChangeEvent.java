...
public class ChangeEvent extends EventObject {
	 ...
	 */
	private static final long serialVersionUID = 8456299019915846568L;
	...
	/**
	 * 
	 * Construct a ChangeEvent specifying a new value for a property, and giving
	 * the previous value.
	 * 
	 * @param source
	 *            The object being changed.
	...
	/**
	 * 
	 * Return an object which is to be the new value of some property, or is to
	 * be added to a collection. May return <code>null</code> is this is not
	 * meaningful.
	 * 
	...
	/**
	 * 
	 * Return the event which caused this to be fired, or <code>null</code> if
	 * this change was not caused by another event.
	 * 
	...
	public String toString() {
		return super.toString() + "[" + "type:" + getType() + ", change: "
				+ getChange() + ", previous: " + getPrevious()
