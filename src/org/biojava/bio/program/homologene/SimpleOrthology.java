...
/**
 * A no-frills implementation of the Orthology interface
 *
 * @author David Huen
 */
public class SimpleOrthology implements Orthology
{
    ...
    {
        if (!(o instanceof Orthology)) return false;

        Orthology other = (Orthology) o;
        ...
        // be another Orthology with the same orthologues
        // and SimilarityType.
