 ...
 */
public class GFResultSetFeature
    extends GFResultSetFeatureHolder
    implements StrandedFeature, GFFeature
{
    ...
    GFResultSetFeature(GadflyDB parentDB, int sf_id)
    ...
    public boolean containsFeature(Feature f)
    {
        ...
        if (f instanceof GFFeature) {
            ...
            try {
                ...
                stmt = conn.createStatement();
                rs = stmt.executeQuery(
                    "SELECT count(*) FROM sf_produces_sf WHERE produced_by_sf_id=" + sf_id
                    + "AND produces_sf_id=" + f_id + ";");
