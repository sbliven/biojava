 ...
 * [FIXME] Format reader for GenBank files.  This is currently non-functional,

 * and needs to be fixed to work in the newio style
...
public class GenbankFormat implements  Serializable {
...
//      GenbankContext ctx = new GenbankContext(symParser, sf, featureBuilder);
...
//      GenbankContext(SymbolParser symParser,
...
//  		symbols.addAll(symParser.parse(token).toList());
