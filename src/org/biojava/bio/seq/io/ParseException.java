...
public class ParseException extends BioException {
	 ...
	 */
	private static final long serialVersionUID = -4634667811603426977L;
	 ...
	 * 
	 * @param format
	 *            the format object that was doing the parsing
	 * @param accession
	 *            the accession number of the record that failed
	 * @param identifier
	 *            the identifier of the sequence that failed (eg the GI number
	 *            for genbank)
	 * @param comments
	 *            any additional information
	 * @param parseBlock
	 *            the chunk of the file the parser was trying to parse when the
	 *            error occured
	 * @return the formatted error message
	 */
	public static String newMessage(Class<?> format, String accession,
			String identifier, String comments, String parseBlock) {
