...
// Constructors and initialization
    static
    {
		SeqFileFormerFactory.addFactory("RefSeq:Protein", new ProteinRefSeqFileFormer.Factory());
    }

	private ProteinRefSeqFileFormer()
	{
		super();
	}

	private ProteinRefSeqFileFormer(PrintStream theStream)
	{
		super(theStream);
	}
...
// Private methods
    private static class Factory extends SeqFileFormerFactory
    {
		...
		{
	    	return new ProteinRefSeqFileFormer(System.out);
		}
    }
}
