 ...
 * BioRuntimeExceptions. If you know what you are doing, you can catch these and
 * do something sensible with them. An example would be an iterator() method
...
public class BioRuntimeException extends RuntimeException {
	 ...
	 */
	private static final long serialVersionUID = -6653903277282676021L;
	 ...
	 * 
	 * @param ex
	 *            the Throwable that caused this BioRuntimeException
	 */
