...
public abstract class AbstractChromatogram implements Chromatogram {
    ...
    public Chromatogram reverseComplement() {
        ...
        try {
            ...
            throw new BioError(ise, "Can't happen -- all symbols are explicit and legal");
        }
        Alignment revBC = reverseComplementBaseCalls();
        try {
            rev.setBaseCallAlignment(revBC);
        } catch (IllegalAlphabetException iae) {
            throw new BioError(iae,  "Can't happen unless reverseComplementBaseCalls or reverseComplementBaseCallList have been overridden out-of-spec");
        } catch (NoSuchElementException nsee) {
            throw new BioError(nsee, "Can't happen unless reverseComplementBaseCalls or reverseComplementBaseCallList have been overridden out-of-spec");
    ...
    protected SymbolList reverseComplementBaseCallList(Object label) {
        if (label == DNA) {
            try {
                ...
                throw new BioError(iae, "Can't happen unless the DNA list has been set improperly");
            }
        }
