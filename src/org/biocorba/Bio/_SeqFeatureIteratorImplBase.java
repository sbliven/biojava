/*
 * File: SRC/ORG/BIOCORBA/BIO/_SEQFEATUREITERATORIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
public abstract class _SeqFeatureIteratorImplBase extends org.omg.CORBA.DynamicImplementation implements org.biocorba.Bio.SeqFeatureIterator {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // org.biocorba.GNOME.Unknown.query_interface
              ...
              break;
           case 3: // org.biocorba.Bio.SeqFeatureIterator.next
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              org.biocorba.Bio.SeqFeature ___result;
                            ___result = this.next();
              org.omg.CORBA.Any __result = _orb().create_any();
              org.biocorba.Bio.SeqFeatureHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 4: // org.biocorba.Bio.SeqFeatureIterator.has_more
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              boolean ___result;
