/*
 * File: SRC/ORG/BIOCORBA/BIO/_PRIMARYSEQSTREAMIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
public abstract class _PrimarySeqStreamImplBase extends org.omg.CORBA.DynamicImplementation implements org.biocorba.Bio.PrimarySeqStream {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // org.biocorba.GNOME.Unknown.query_interface
              ...
              break;
           case 3: // org.biocorba.Bio.PrimarySeqStream.next
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              ...
              catch (org.biocorba.Bio.EndOfStream e0) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            org.biocorba.Bio.EndOfStreamHelper.insert(_except, e0);
                            r.except(_except);
                            return;
              }
              ...
              break;
           case 4: // org.biocorba.Bio.PrimarySeqStream.has_more
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              boolean ___result;
