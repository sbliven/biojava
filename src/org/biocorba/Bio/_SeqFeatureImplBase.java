/*
 * File: SRC/ORG/BIOCORBA/BIO/_SEQFEATUREIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
public abstract class _SeqFeatureImplBase extends org.omg.CORBA.DynamicImplementation implements org.biocorba.Bio.SeqFeature {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // org.biocorba.GNOME.Unknown.query_interface
              ...
              break;
           case 3: // org.biocorba.Bio.SeqFeature.type
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String ___result;
              ...
              break;
           case 4: // org.biocorba.Bio.SeqFeature.source
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String ___result;
              ...
              break;
           case 5: // org.biocorba.Bio.SeqFeature.seq_primary_id
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String ___result;
              ...
              break;
           case 6: // org.biocorba.Bio.SeqFeature.start
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              int ___result;
              ...
              break;
           case 7: // org.biocorba.Bio.SeqFeature.end
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              int ___result;
              ...
              break;
           case 8: // org.biocorba.Bio.SeqFeature.strand
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              short ___result;
              ...
              break;
           case 9: // org.biocorba.Bio.SeqFeature.qualifiers
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              org.biocorba.Bio.NameValueSet[] ___result;
                            ___result = this.qualifiers();
              org.omg.CORBA.Any __result = _orb().create_any();
              org.biocorba.Bio.NameValueSetListHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 10: // org.biocorba.Bio.SeqFeature.has_PrimarySeq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              boolean ___result;
              ...
              break;
           case 11: // org.biocorba.Bio.SeqFeature.get_PrimarySeq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
