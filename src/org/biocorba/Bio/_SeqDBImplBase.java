/*
 * File: SRC/ORG/BIOCORBA/BIO/_SEQDBIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
public abstract class _SeqDBImplBase extends org.omg.CORBA.DynamicImplementation implements org.biocorba.Bio.SeqDB {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // org.biocorba.GNOME.Unknown.query_interface
              ...
              break;
           case 3: // org.biocorba.Bio.PrimarySeqDB.database_name
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String ___result;
              ...
              break;
           case 4: // org.biocorba.Bio.PrimarySeqDB.database_version
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              short ___result;
              ...
              break;
           case 5: // org.biocorba.Bio.PrimarySeqDB.make_stream
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              org.biocorba.Bio.PrimarySeqStream ___result;
                            ___result = this.make_stream();
              org.omg.CORBA.Any __result = _orb().create_any();
              org.biocorba.Bio.PrimarySeqStreamHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 6: // org.biocorba.Bio.PrimarySeqDB.get_PrimarySeq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              ...
              catch (org.biocorba.Bio.UnableToProcess e0) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            org.biocorba.Bio.UnableToProcessHelper.insert(_except, e0);
                            r.except(_except);
                            return;
              }
              org.omg.CORBA.Any __result = _orb().create_any();
              ...
              break;
           case 7: // org.biocorba.Bio.SeqDB.get_Seq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              org.omg.CORBA.Any _primary_id = _orb().create_any();
              _primary_id.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
              ...
              String primary_id;
              primary_id = _primary_id.extract_string();
              org.biocorba.Bio.Seq ___result;
              try {
              ...
              org.omg.CORBA.Any __result = _orb().create_any();
              org.biocorba.Bio.SeqHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
            default:
