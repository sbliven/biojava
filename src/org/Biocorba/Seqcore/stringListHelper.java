/*
 * File: ..\SRC/ORG/BIOCORBA/SEQCORE/STRINGLISTHELPER.JAVA
...
public class stringListHelper {
   ...
   synchronized public static org.omg.CORBA.TypeCode type() {
          if (_tc == null)
             _tc = org.omg.CORBA.ORB.init().create_alias_tc(id(), "stringList", org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string)));
      return _tc;
   }
   public static String id() {
       return "IDL:org/Biocorba/Seqcore/stringList:1.0";
   }
}
