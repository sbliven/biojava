/*
 * File: ..\SRC/ORG/BIOCORBA/SEQCORE/_SEQDBIMPLBASE.JAVA
...
public abstract class _SeqDBImplBase extends org.omg.CORBA.DynamicImplementation implements org.Biocorba.Seqcore.SeqDB {
    // Constructor
    public _SeqDBImplBase() {
         super();
    }
    ...
    static {
      ...
      _methods.put("make_PrimarySeqIterator", new java.lang.Integer(5));
      _methods.put("get_PrimarySeq", new java.lang.Integer(6));
      _methods.put("get_Seq", new java.lang.Integer(7));
      _methods.put("get_primaryidList", new java.lang.Integer(8));
     }
    // DSI Dispatch call
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // GNOME.Unknown.query_interface
              ...
              break;
           case 3: // org.Biocorba.Seqcore.PrimarySeqDB.database_name
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String ___result;
              ...
              break;
           case 4: // org.Biocorba.Seqcore.PrimarySeqDB.database_version
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              short ___result;
              ...
              break;
           case 5: // org.Biocorba.Seqcore.PrimarySeqDB.make_PrimarySeqIterator
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              org.Biocorba.Seqcore.PrimarySeqIterator ___result;
                            ___result = this.make_PrimarySeqIterator();
              org.omg.CORBA.Any __result = _orb().create_any();
              org.Biocorba.Seqcore.PrimarySeqIteratorHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 6: // org.Biocorba.Seqcore.PrimarySeqDB.get_PrimarySeq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              ...
              break;
           case 7: // org.Biocorba.Seqcore.SeqDB.get_Seq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              org.omg.CORBA.Any _primary_id = _orb().create_any();
              _primary_id.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
              ...
              String primary_id;
              primary_id = _primary_id.extract_string();
              org.Biocorba.Seqcore.Seq ___result;
              try {
                            ___result = this.get_Seq(primary_id);
              }
              catch (org.Biocorba.Seqcore.UnableToProcess e0) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            org.Biocorba.Seqcore.UnableToProcessHelper.insert(_except, e0);
              ...
              org.omg.CORBA.Any __result = _orb().create_any();
              org.Biocorba.Seqcore.SeqHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 8: // org.Biocorba.Seqcore.SeqDB.get_primaryidList
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              String[] ___result;
                            ___result = this.get_primaryidList();
              org.omg.CORBA.Any __result = _orb().create_any();
              org.Biocorba.Seqcore.primaryidListHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
            default:
