/*
 * File: SRC/BIO/_SEQFEATUREITERATORIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
package Bio;
public abstract class _SeqFeatureIteratorImplBase extends org.omg.CORBA.DynamicImplementation implements Bio.SeqFeatureIterator {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 2: // GNOME.Unknown.query_interface
              ...
              break;
           case 3: // Bio.SeqFeatureIterator.next
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              Bio.SeqFeature ___result;
                            ___result = this.next();
              org.omg.CORBA.Any __result = _orb().create_any();
              Bio.SeqFeatureHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 4: // Bio.SeqFeatureIterator.has_more
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              boolean ___result;
