/*
 * File: SRC/BIO/_PRIMARYSEQSTREAMSTUB.JAVA
 * From: IDL/BIO.IDL
...
public class _PrimarySeqStreamStub
	extends org.omg.CORBA.portable.ObjectImpl
    	implements Bio.PrimarySeqStream {
    ...
    public org.omg.CORBA.Object query_interface(String repoid)
 {
    ...
    public Bio.PrimarySeq next()
        throws Bio.EndOfStream, Bio.UnableToProcess {
           ...
           r.exceptions().add(Bio.EndOfStreamHelper.type());
           ...
           if (__ex instanceof org.omg.CORBA.UnknownUserException) {
               ...
               if (__userEx.except.type().equals(Bio.EndOfStreamHelper.type())) {
                   throw Bio.EndOfStreamHelper.extract(__userEx.except);
               }
