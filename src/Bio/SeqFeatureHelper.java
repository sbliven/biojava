/*
 * File: SRC/BIO/SEQFEATUREHELPER.JAVA
 * From: IDL/BIO.IDL
...
public class SeqFeatureHelper {
    ...
    public static Bio.SeqFeature read(org.omg.CORBA.portable.InputStream in) {
        return Bio.SeqFeatureHelper.narrow(in.read_Object());
    }
   ...
   public static Bio.SeqFeature narrow(org.omg.CORBA.Object that)
	    throws org.omg.CORBA.BAD_PARAM {
        if (that == null)
            return null;
        if (that instanceof Bio.SeqFeature)
            return (Bio.SeqFeature) that;
	if (!that._is_a(id())) {
	    throw new org.omg.CORBA.BAD_PARAM();
	}
        org.omg.CORBA.portable.Delegate dup = ((org.omg.CORBA.portable.ObjectImpl)that)._get_delegate();
        Bio.SeqFeature result = new Bio._SeqFeatureStub(dup);
        return result;
   }
}
