/*
 * File: SRC/BIO/_SEQFEATURESTUB.JAVA
 * From: IDL/BIO.IDL
...
public class _SeqFeatureStub
    ...
    public Bio.NameValueSet[] qualifiers()
 {
           ...
           r.set_return_type(Bio.NameValueSetListHelper.type());
           r.invoke();
           Bio.NameValueSet[] __result;
           __result = Bio.NameValueSetListHelper.extract(r.return_value());
           return __result;
   }
