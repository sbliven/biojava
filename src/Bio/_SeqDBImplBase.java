/*
 * File: SRC/BIO/_SEQDBIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
package Bio;
public abstract class _SeqDBImplBase extends org.omg.CORBA.DynamicImplementation implements Bio.SeqDB {
    // Constructor
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 7: // Bio.SeqDB.get_Seq
              ...
              org.omg.CORBA.Any __result = _orb().create_any();
              Bio.SeqHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
            default:
