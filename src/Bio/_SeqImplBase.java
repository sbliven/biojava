/*
 * File: SRC/BIO/_SEQIMPLBASE.JAVA
 * From: IDL/BIO.IDL
...
package Bio;
public abstract class _SeqImplBase extends org.omg.CORBA.DynamicImplementation implements Bio.Seq {
    // Constructor
    public _SeqImplBase() {
         super();
    }
    ...
    public void invoke(org.omg.CORBA.ServerRequest r) {
       switch (((java.lang.Integer) _methods.get(r.op_name())).intValue()) {
           ...
           case 11: // Bio.PrimarySeq.max_request_length
              ...
              break;
           case 12: // Bio.Seq.all_features
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              Bio.SeqFeature[] ___result;
              try {
              ...
              org.omg.CORBA.Any __result = _orb().create_any();
              Bio.SeqFeatureListHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 13: // Bio.Seq.all_features_iterator
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              Bio.SeqFeatureIterator ___result;
                            ___result = this.all_features_iterator();
              org.omg.CORBA.Any __result = _orb().create_any();
              Bio.SeqFeatureIteratorHelper.insert(__result, ___result);
              r.result(__result);
              }
              break;
           case 14: // Bio.Seq.features_region
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              org.omg.CORBA.Any _start = _orb().create_any();
              _start.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_long));
              ...
              catch (Bio.RequestTooLarge e2) {
                            org.omg.CORBA.Any _except = _orb().create_any();
                            Bio.RequestTooLargeHelper.insert(_except, e2);
                            r.except(_except);
                            return;
              }
              org.omg.CORBA.Any __result = _orb().create_any();
              ...
              break;
           case 15: // Bio.Seq.features_region_iterator
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              org.omg.CORBA.Any _start = _orb().create_any();
              _start.type(org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.tk_long));
              ...
              break;
           case 16: // Bio.Seq.max_feature_request
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
              int ___result;
              ...
              break;
           case 17: // Bio.Seq.get_PrimarySeq
              {
              org.omg.CORBA.NVList _list = _orb().create_list(0);
              r.params(_list);
