# Prints useful stats about oligo related data in a database
...
select count(*) as count_oligos_in_object_xref from object_xref ox, xref x where ox.xref_id=x.xref_id and external_db_id>3000 and external_db_id<3200;

select count(*) as count_oligos_in_xref from xref where external_db_id>3000 and external_db_id<3200;
...
select count(distinct(probeset)) as count_probeset from oligo_probe;
