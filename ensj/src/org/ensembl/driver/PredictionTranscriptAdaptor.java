...
/**
 * Provides access to PredictionTranscripts in the datasource.
 */
public interface PredictionTranscriptAdaptor extends FeatureAdaptor {

  final static String TYPE = "prediction_transcript";
  
  PredictionTranscript fetch( long internalID ) throws AdaptorException;
  ...
  long store( PredictionTranscript predictionTranscript ) throws
  AdaptorException;
