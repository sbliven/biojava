...
public class ExonDumper {
     ...
     * @return true if source and target exons were dumped.
     */
    public boolean dumpFilteredExons(Cache cache, ScoredMappingMatrix matrix, String rootDir) {
        ...
        return sourceExons.size()>0 && targetExons.size()>0;
