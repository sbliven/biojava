...
public class TranscriptSnapShotImpl implements TranscriptSnapShot {
  ...
  private static final long serialVersionUID = 1L;
	...
	/**
	 * Creates TranscriptSnapShotImpl with specified parameters. 
	 */
	...
	/**
	 * Returns an array of transcripts in the correct order.
	 * @param transcripts a list of TranscriptSnapShots
	 */
	public static TranscriptSnapShot[] toArray(List transcripts) {
		TranscriptSnapShot[] array = new TranscriptSnapShot[ transcripts.size() ];
		transcripts.toArray( array );
		return array;
	}
