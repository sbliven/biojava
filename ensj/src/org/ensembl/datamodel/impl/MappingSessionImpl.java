...
public class MappingSessionImpl extends PersistentImpl implements MappingSession {
  ...
  public MappingSessionImpl(String oldDatabase, String newDatabase) {
  ...
  public String getNewDatabase(){ return newDatabase; }

  public void setNewDatabase(String newDatabase){ this.newDatabase = newDatabase; }

  public String getOldDatabase(){ return oldDatabase; }

  public void setOldDatabase(String oldDatabase){ this.oldDatabase = oldDatabase; }
  ...
  public String toString() {
    ...
    buf.append( "oldDatabase=" ).append( oldDatabase ).append(", ");
    buf.append( "newDatabase=" ).append( newDatabase ).append(", ");
