...
**/
public interface GenomicAlignBlockAdaptor extends Adaptor{
  static final String TYPE = "genomic_align_block";
  ...
  public List fetch(MethodLinkSpeciesSet methLinkSpecSet, Location location) throws AdaptorException;
